...
namespace RussianPost
{
    public sealed partial class PackagePage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Package PackageObject = (Package)e.Parameter;
            TrackIDLabel.Text = PackageObject.ID;
            TrackID = PackageObject.ID;
            TrackNameLabel.Text = PackageObject.Name;
            movingHistoryList.ItemsSource = PackageObject.History;
            PackageDescription.Text = PackageObject.Description;
        }
        ...
        {
            BarcodeDialog dialog = new BarcodeDialog(TrackID);
